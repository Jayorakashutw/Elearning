...
<!-- Mirrored from edutec-html.vercel.app/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jun 2025 19:59:06 GMT -->
					...
					<div class="col-xl-6 mx-auto wow fadeIn">
						<div class="login">
							...
							<div class="form-group">
								...
								<input type="text" id="contact-name" placeholder="Username or Email" class="form-control" name="name">
							</div>
							<div class="form-group">
							...
							<div class="form-group col-lg-12">
								<button class="bg-btn" type="submit" name="submit">Sign In <i class="fa-solid fa-arrow-right"></i></button>
							</div>
