...
<!-- Mirrored from edutec-html.vercel.app/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jun 2025 19:59:07 GMT -->
				...
				<div class="row">				
					<div class="col-xl-6 mx-auto wow fadeIn">
						<div class="register">
							...
							<div class="form-group">
								<label for="cpwd">Password<span>*</span></label>
								<input type="password" placeholder="Enter Password" id="cpwd" class="form-control" name="password" >
							</div>
							<div class="form-group col-lg-12">
								<button class="bg-btn" type="submit" name="submit">Sign Up <i class="fa-solid fa-arrow-right"></i></button>
							</div>
