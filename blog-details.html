...
<!-- Mirrored from edutec-html.vercel.app/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jun 2025 19:59:05 GMT -->
...
<head>
		...
		<!-- SITE TITLE -->
		<title>Blog Details - edutec</title>
		<!-- Favicon Icon -->
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-12 text-center z-1 position-relative wow fadeInUp">
						<h2>Blog Details</h2>
						<p>
							<a href="#">Home</a> <i class='bx bx-chevrons-right'></i> Blog Details
						</p>
					</div>
				</div>				
			</div>
				...
				<div class="row">
					<div class="col-xl-8 col-lg-8 col-md-12 col-12 wow fadeIn">
						<div class="post-inner">
							...
							<div class="post-nav pnavigation">
								<a href="#" class="prev-pro">															 								
									
									Preview Posts
								</a>	

								<a href="#" class="next-pro">
									Next Post 						
						...
						<div class="comments">
							<h2 class="bdtitle">Comments - 03</h2>
								...
								<li class="comment">
									<div class="single-comment">
										<div class="float-start com-img">
											...
											<span class="cdate">13 Jan, 2025</span>
											
											<a href="#" class="creplay"><i class='bx bx-reply'></i></a>
						...
						<div class="comment-form">
							<h2 class="bdtitle">Comment</h2>
							<form action="#" method="post">
								<div class="d-flex name_email">
									<p>
										<label for="name">Write Full Name</label>
