...
<!-- Mirrored from edutec-html.vercel.app/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jun 2025 19:59:07 GMT -->
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-12 text-center z-1 position-relative wow fadeInUp">
						<h2>404</h2>
						<p>
							<a href="#">Home</a> <i class='bx bx-chevrons-right'></i> 404
						</p>
					</div>
				</div>				
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-7 mx-auto text-center wow fadeIn">
						...
						<a href="index.html" class="bg-btn"><i class="fa-solid fa-arrow-left-long"></i> Back To Home</a>
					</div><!-- End Col -->			
