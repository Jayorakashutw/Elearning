...
<head>
		...
		<!-- SITE TITLE -->
		<title>Course Details - Edutec</title>	
		<!-- Favicon Icon -->
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-12 text-center z-1 position-relative wow fadeInUp">
						...
						<p>
							<a href="#">Home</a> <i class='bx bx-chevrons-right'></i> Course Details
						</p>
					</div>
				</div>				
			</div>
				...
				<div class="row">
					<div class="col-xl-8 wow fadeIn">
						<div class="scourse_image">
							<img src="assets/img/course/course-details.jpg" alt="image">	
						</div>
						
						<div class="scourse_meta">
							<div class="smeta">
								<img src="assets/img/instructors/avatar.png" alt="author">
						...
						<h2 class="scourse-title">The Complete Web Devoloper Guideline 2025</h2>
						...
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab" tabindex="0">
								<h3 class="cdtitle">Course Description</h3>
								<p>
							...
							<div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab" tabindex="0">
								<div class="cd_rating">
									...
									<div class="rating_list">
										...
										<div class="rating_item">
											<div class="rating_item_avatar">
												<img src="assets/img/review/2.png" alt="avatar">
												<div class="rava_conent">
													<h3>Robert Max</h3>
													<p>Outstanding Course </p>
													<span class="rating_item_ricon">
										...
										<div class="rating_item">
											<div class="rating_item_avatar">
												<img src="assets/img/review/3.png" alt="avatar">
												<div class="rava_conent">
													<h3>Robert Max</h3>
													<p>Outstanding Course </p>
													<span class="rating_item_ricon">
									...
									<div class="cdr_review_form">
										...
										<form action="#" class="rating_form">
											...
											<button type="submit" class="bg-btn">
												Submit Review
											</button>
										</form>
									</div>
							...
							<div class="tab-pane fade" id="nav-instructor" role="tabpanel" aria-labelledby="nav-instructor-tab" tabindex="0">
								<div class="cd_instructor">
									<div class="cdin_image">
										<img src="assets/img/instructors/1.png" alt="">
										<ul>
											<li>
									...
									<div class="cdin_content">
										<h4><a href="#">Masum Billah</a></h4>
										<span>Web Designer</span>
										<p>
											Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard 
										</p>
										<div class="cdin_meta">
											<div class="cdin_meta_item"><i class="fa-solid fa-graduation-cap"></i> 25+ Students</div>
											<div class="cdin_meta_item"><i class='fa-solid fa-file-circle-check'></i> 32 Courses</div>
										</div>		
									</div>		
								</div>		
							</div>		
					...
					<div class="col-xl-4 wow fadeIn">
						<div class="course-sidebar">
							<div class="cd-video mb-3">
								<iframe width="560" height="315" src="https://www.youtube.com/embed/AnQ7XZHnxvk?si=EVeOUkNZgl-UeY6Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
							</div>
							
							<div class="cd_price mb-3">
								$300
							</div>
							
							<div class="text-start mb-4">
								<a href="cart.html" class="bg-btn">Enroll Now <i class="fa-solid fa-arrow-right-long"></i></a>
							</div>
...
<!-- Mirrored from edutec-html.vercel.app/course-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jun 2025 19:59:04 GMT -->
</html>